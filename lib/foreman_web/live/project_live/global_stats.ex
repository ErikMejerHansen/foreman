defmodule ForemanWeb.ProjectLive.GlobalStats do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     socket
     |> assign(:tasks, tasks)
     |> assign(:page_title, "Global Stats")
     |> assign(:sort_by, :cost)
  ...
  defp task_sort_value(task, :project), do: task.project.name || ""
    ...
    <div class="min-h-screen flex flex-col">
      ...
      <div class="bg-base-100 border-b border-base-300 px-6 py-4 flex justify-between items-center">
        <div class="flex items-center gap-4">
          ...
          <h1 class="text-xl font-bold">Global Statistics</h1>
        </div>
        <div class="flex items-center gap-4">
            ...
            <table class="w-full text-sm">
              <thead class="bg-base-200/50 border-b border-base-300">
                <tr>
                  <th class="text-left px-4 py-3 font-medium">
                    <button phx-click="sort" phx-value-col="project" class="hover:text-base-content">
                      Project{sort_indicator(:project, @sort_by, @sort_dir)}
                    </button>
                  </th>
                  <th class="text-left px-4 py-3 font-medium">
              ...
              <tbody class="divide-y divide-base-300">
                ...
                <%= if Enum.empty?(@tasks) do %>
                  <tr>
                    <td colspan="11" class="px-4 py-8 text-center text-base-content/40">
                      No tasks yet
                    </td>
                  </tr>
                <% end %>
